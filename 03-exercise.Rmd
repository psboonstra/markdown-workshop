...
In these exercises you will explore the xenograft data. Create code chunks to do the necessary calculations and save your results. Write English prose to answer the questions.
...
the code is doing. Be sure to look up any unfamiliar functions. 
...
Separately for each treatment group, create code chunks to calculate for each of days 0, 7, and 14 the following statistics: the mean tumor size, the mean
*relative* tumor size, and the number of measurements. Report these statistics. Which group had the largest typical growth between day 0 and days 7 / 14? Which group had the most measurements taken on day 14? Why do you think the mice have different
numbers of measurements taken on these days?


*Hint* You might find useful the `n()` function useful. It counts the current group 
