...
Knit the document and take note of how the sentence below ("The probability that"...)
gets formatted. Now remove the brackets ("`{`" and "`}`") from this sentence:

> The probability that 10 independent Bernoulli trials each with probability of success 
equal to 0.5 will yield at most 4 successes is `{r pbinom(q = 4, size = 10, prob = 0.5)}` 
