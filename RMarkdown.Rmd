...
`r ''````{r, out.width = paste0(image_scaler*400,"px"), echo = F}
include_graphics("images/knit_menu.png")
```
````
...
## Try it out: Option 1
  ...
  b. Download RStudio to interface with R (https://www.rstudio.com/)
...
Complete the tasks in `01-exercise.Rmd`. Answer the following question when you 
are done

<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/CxGiXDjOcIBduE9tbwmVO?controls=presentation&amp;force=--+none+--&amp;push=manual" width="40%" height="15%" frameBorder="0"></iframe> 
...
Open `02-exercise.R` and complete the tasks. Answer the following question
when you are done

<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/mn5LYOGSd1Ivrh84IfLTW?controls=presentation&amp;force=--+none+--&amp;push=manual" width="40%" height="15%" frameBorder="0"></iframe> 
...
How did R know this was my desired working directory? Why didn't I need to do this?
...
<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/vBCEpR1NY7uFIClIX5lux?controls=presentation&amp;force=--+none+--&amp;push=manual" width="100%" height="80%" frameBorder="0"></iframe> 
...
tumor_growth %>% 
  ...
  summarize(n = n()) %>% 
  summarize(n = mean(n)) %>% 
  pull(n) # pull extracts the named column as a vector
```
...
Open `03-exercise.Rmd` and complete the tasks. Work with your breakout room partners. 
Answer the following question if desired


<iframe src="https://embed.polleverywhere.com/free_text_polls/itx18mT2LCePHk8nuZAPQ?controls=presentation&amp;force=--+none+--&amp;push=manual" width="100%" height="80%" frameBorder="0"></iframe> 
