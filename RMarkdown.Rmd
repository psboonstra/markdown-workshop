...
date: "BDSI 2019; Univeristy of Michigan"
...
library(knitr);
library(countdown);
knitr::opts_knit$set(root.dir = "~/Desktop/Work/BDSI2019");
...
<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/NuFcqnEpRxqJkIlYOBv5m?controls=presentation&amp;force=--+none+--&amp;push=manual" width="100%" height="80%" frameBorder="0"></iframe> 
...
```{r, out.width = paste0(image_scaler*300,"px")}
knitr::include_graphics("images/preview_knit.png")
```
...
## Try it out: Option 1
  ...
  c. Go to https://github.com/psboonstra/umich-globalstatcore-R, then 'Clone or download', then 'Download ZIP'
...
Use ` ```{python} ` to start a python code chunk, ` ```{julia} ` to start a bash code chunk, etc. 
